...
function GUIUpdate_AOHintText()
	...
	if Type == -1 then
		...
		elseif NameAndType[2] == "Extra3" then
			HintText = XGUIEng.GetStringTableText( "CM07_MapHints/" .. Name )
		elseif NameAndType[2] == "Extra3_2" then
			HintText = XGUIEng.GetStringTableText( "CM08_MapHints/" .. Name )
		else
