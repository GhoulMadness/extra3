...
function SPMenu.S70_UpdateCampaign3_Maps()
	...
	do
		if i <= 1 then
			...
			local GDBKeyName = 	"Game\\Campaign07\\WonMap_" .. SPMenu.AO3Campaign_Maps[i-1]			
...
function SPMenu.S70_CheckMapCheat( _Message, _MapName )
	...
	local StringKeyName = "AO3MapCheats/WonMap_" .. _MapName
	...
	local GDBKeyName = 	"Game\\Campaign07\\WonMap_" .. _MapName
