...
function P4FComforts_FreeCamera_Button()
	...
	GUITooltip_Generic = function(a)
		if a == "MenuMap/OnlineHelp" then
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomText, ("@color:180,180,180 Kamera zurücksetzen @color:173,255,47 @cr Klickt hier um den Standard Kamerawinkel einzustellen."..
...
-- note: uses function InitColors and HasPlayerEnoughResources
	...
	GUITooltip_Generic = function(a)
		if a == "MenuBuildingGeneric/RecruitGroups" then
			if gvMission.Autofill[gvMission.PlayerID] == true then
				XGUIEng.SetText(gvGUI_WidgetID.TooltipBottomText, ("@color:180,180,180 Automatisches Rekrutieren ausschalten @cr @color:255,255,255 Eure Hauptmänner werden nur neue Soldaten in ihre Gruppe aufnehmen, wenn Ihr es ihnen befehlt."))
			else
				XGUIEng.SetText(gvGUI_WidgetID.TooltipBottomText, ("@color:180,180,180 Automatisches Rekrutieren anschalten @cr @color:255,200,0 ermöglicht: @color:255,255,255 Eure Hauptmänner können selbstständig neue Soldaten in ihre Gruppe aufnehmen, sofern genügend Plätze und Rohstoffe vorhanden sind."))
			end
			XGUIEng.SetText(gvGUI_WidgetID.TooltipBottomCosts, "")
			XGUIEng.SetText(gvGUI_WidgetID.TooltipBottomShortCut, "")
		else
	...
	GUITooltip_Generic = function( ttString )
		...
		if ttString == "MenuBuildingGeneric/RecruitSingleLeader" then
			...
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomText,
				("@color:180,180,180 Nur Hauptmann/Gruppe rekrutieren"..
		...
		elseif ttString == "MenuBuildingGeneric/RecruitGroups" then
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomText,
				("@color:180,180,180 Sofort nachrekrutieren"..
...
function P4FComforts_EnableGlobalTroopSelection()
	...
	GUITooltip_Generic = function( ttString )
		...
		if newText then
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomText, (newText) )
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomCosts, "" )
			XGUIEng.SetText( gvGUI_WidgetID.TooltipBottomShortCut, "" )
		end
	end
