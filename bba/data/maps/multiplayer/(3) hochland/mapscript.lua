...
CreateNVArmies = function()
	local armies = {
		{player = 8, id = 0, strength = 7, spawnTypes = {{Entities.CU_Evil_LeaderBearman1, 16}, {Entities.CU_Evil_LeaderSkirmisher1, 16}},
		...
		{player = 8, id = 1, strength = 7, spawnTypes = {{Entities.CU_Evil_LeaderBearman1, 16}, {Entities.CU_Evil_LeaderSkirmisher1, 16}},
