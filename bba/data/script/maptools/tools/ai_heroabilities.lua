gvHeroAbilities = {
	...
	HerosWithHealingAura = {
		[Entities.PU_Hero3] = true,
		[Entities.CU_Barbarian_Hero] = true
	},
	AuraAffectedCategoryByHeroType = {
		[Entities.PU_Hero3] = "Allies",
	...
	InternalAbilities = {
		...
		["Hero13"] = {
			["StoneArmor"] = {LastTimeUsed = {}, Cooldown = gvHero13.Cooldown.StoneArmor},
			["DivineJudgment"] = {LastTimeUsed = {}, Cooldown = gvHero13.Cooldown.DivineJudgment}
		},
		["Hero14"] = {
			["CallOfDarkness"] = {LastTimeUsed = {}, Cooldown = gvHero14.CallOfDarkness.Cooldown},
	...
	AbilitiesByHero = {
		[Entities.PU_Hero1] = {Abilities.AbilityInflictFear},
	...
	CastAbility = {
		[Abilities.AbilityInflictFear] = function(_heroID)
	...
	CheckByAbility = {
		[Abilities.AbilityInflictFear] = function(_heroID, _posX, _posY, _player)
