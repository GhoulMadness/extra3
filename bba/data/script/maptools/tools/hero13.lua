	...
	AbilityProperties = {
		...
		DivineJudgment = {
			...
			Judgment = {
				...
				BaseRange = 1200,
				BaseExponent = 2.5,
				RangeDelayFalloff = 10,
				ExponentDelayFalloff = 50,
				NumberOfLightningStrikes = 10,
				DamageFalloff = 0.07,
				MinDamage = 0.2,
				MinAttackDamageFactor = 4,
				DamageFactors = {
					Hero = 2,
					Building = 8
				},
				TimesUsed = {},
				RangeFalloffPerCast = 120,
				MinRange = 500,
				DamageFactorBonus = {},
				RangeFactorBonus = {}
			},
			CalculateBonusEffects = {
				...
				DamageFactorBonusPerMs = 1/(7*60*1000),
				MaxDamageFactorBonus = 4,
				RangeFactorBonusPerMs = 1/(17*60*1000),
				MaxRangeFactorBonus = 2
			}
		}
	},
	AbilityNameRechargeButtons = {
		StoneArmor = "Hero13_RechargeStoneArmor",
		DivineJudgment = "Hero13_RechargeDivineJudgment"
	},
