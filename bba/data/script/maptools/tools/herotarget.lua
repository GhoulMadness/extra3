gvHeroTarget = {
	...
	EndangeredCats = {
		...
		EntityCategories.Soldier,
		EntityCategories.Hero,
	...
	AffectedEntCountFuncByHero = {
		[Entities.PU_Hero4] = GetNumberOfAlliesInRange,
	...
	MainThreat = {
		...
		[Entities.PU_Hero2] = {
			"CloseRange",
			Abilities.AbilityPlaceBomb
		},
		[Entities.PU_Hero3] = {
			"CloseRange",
			Abilities.AbilityBuildCannon
		},
		[Entities.PU_Hero4] = {
			"AbilityAtDistance",
		...
		[Entities.CU_Mary_de_Mortfichet] = {
			"CloseRange",
			Abilities.AbilityCircularAttack
		},
		[Entities.CU_Barbarian_Hero] = {
			"AbilityAtDistance",
			Abilities.AbilityRangedEffect
