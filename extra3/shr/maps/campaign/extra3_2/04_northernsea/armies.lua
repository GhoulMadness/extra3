...
function StartCamps()
	...
	army.rodeLength = 4400 - round(200*gvDiffLVL)
	SetupArmy(army)
	...
	army.rodeLength = 4400 - (200*gvDiffLVL)
	SetupArmy(army)
	for i = 1, army.strength do
		EnlargeArmy(army, {leaderType = CampTroopTypes[math.random(table.getn(CampTroopTypes))]})
	end
...
function Attack_2_Vorb()
	...
	ASP("Kerb",ker,"Die Nordfeste leistet mehr Widerstand als erwartet.", false)
	ASP("Lighthouse",ker,"Los meine Mannen. @cr Gebt das Signal, sodass sich alle verstreuten Schergen hier einfinden werden. @cr Schon bald wird die Nordfeste unser sein!", false)
	...
	briefing.finished = function()
		...
		StartCountdown(1, function() Trigger.RequestTrigger(Events.LOGIC_EVENT_ENTITY_HURT_ENTITY, "", "DecreaseKerbCounter", 1) end, false)
	end;
