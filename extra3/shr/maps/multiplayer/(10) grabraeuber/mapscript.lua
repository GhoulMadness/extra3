...
EMS_CustomMapConfig =
{
	...
	TagNachtZyklus(14,1,0,4)
	for eID in S5Hook.EntityIterator(Predicate.OfAnyType(Entities.XD_Cobweb1,Entities.XD_Cobweb2,Entities.XD_Cobweb3,Entities.XD_Cobweb4) ) do
        S5Hook.GetEntityMem(eID)[25]:SetFloat(4);
    end
	...
	Callback_OnPeacetimeEnded = function()
		for eID in S5Hook.EntityIterator(Predicate.OfAnyType(Entities.XD_Palisade1,Entities.XD_Palisade2,Entities.XD_Palisade3,Entities.XD_PalisadeGate1,Entities.XD_PalisadeGate2) ) do
