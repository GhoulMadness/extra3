...
--------------------------------------------------------------------------------
-- MapName: (7) Aufstieg des Bösen - Vargs Raubzug
--
-- Author: Ghoul
--
if XNetwork then
...
gvMapText = ""..
		...
		" @cr @cr @cr @color:150,0,255 Ghoul @color:230,0,240 @cr (7) Vargs Raubzug "
gvMapVersion = " v1.1"
...
function Hauptaufgabe()
	...
	tribute7.playerId = 8
	tribute7.text = " "
	tribute7.cost = { Gold = 0 }
	tribute7.Callback = AddMainquestForPlayer7
	TributMainquestP7 = AddTribute(tribute7)
...
function TributeForMainquest()
	...
	GUI.PayTribute(8,TributMainquestP7)
end
...
function AddMainquestForPlayer6()
	Logic.AddQuest(7,7,MAINQUEST_OPEN,"Missionsziele","Baut Eure Siedlungen auf und verteidigt sie gegen mögliche Angriffe! @cr @cr Besiegt Varg! @cr @cr @color:230,100,0 Spieler 1 kann den Spielmodus über das Tributmenü bestimmen!",1)
end
...
function Tribut8()
	local TrMod2 =  {}
	TrMod2.playerId = 1
	TrMod2.text = "Spielmodus @color:0,250,200 <<Kooperation/Schwer>>! "
	TrMod2.cost = { Gold = 0 }
...
function VictoryJob()
	if IsDead("VargHQ") and IsDead("P10HQ") and IsDead("P8HQ")then
		Victory()
		return true
	end
end
...
function SpielmodKoop1()
	...
	gvDiffLVL = 2
	VargTicker = StartCountdown(50*60,VargVorbereitung,true)
	StartCountdown(47*60,AngriffsErinnerung,false)
...
function SetupKi2()
	...
	local constructionplanP2 = {
		...
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 0 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },				-- Haus
		{ type = Entities.PB_Sawmill1, pos = GetPosition("P2Holz3"), level = 1 },		-- Sägemühle
...
function SetupKi4()
	...
	local constructionplanP4 = {
		...
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 0 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },				-- Haus
		{ type = Entities.PB_Archery1, pos = GetPosition("P4Kaserne"), level = 1 },	-- Schießanlage
...
function SetupKi5()
	...
	local constructionplanP5 = {
		...
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 0 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },				-- Haus
		{ type = Entities.PB_Sawmill1, pos = GetPosition("P5Holz3"), level = 1 },		-- Sägemühle
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 1 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },
...
function SetupKi6()
	...
	local constructionplanP6 = {
		...
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 0 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },				-- Haus
		{ type = Entities.PB_Sawmill1, pos = GetPosition("P6Holz3"), level = 1 },		-- Sägemühle
		{ type = Entities.PB_Farm1, pos = invalidPosition, level = 1 },						-- Farm
		{ type = Entities.PB_Residence1, pos = invalidPosition, level = 1 },
...
function AngriffsErinnerung()
	...
	CreateVargArmy1()
	CreateVargArmy3()
	MapEditor_SetupAI(8,round(4-gvDiffLVL),Logic.WorldGetSize(),3,"P8",3,0)
	SetupPlayerAi( 8, {constructing = true, repairing = true, extracting = 1, serfLimit = 9} )
	MapEditor_SetupAI(11,round(4-gvDiffLVL),Logic.WorldGetSize(),3,"P11",3,0)
	SetupPlayerAi( 11, {constructing = true, repairing = true, extracting = 1, serfLimit = 7} )
	MapEditor_SetupAI(9,round(4-gvDiffLVL),Logic.WorldGetSize(),3,"P9",3,0)
	SetupPlayerAi( 9, {constructing = true, repairing = true, extracting = 1, serfLimit = 7} )
	MapEditor_SetupAI(10,round(4-gvDiffLVL),Logic.WorldGetSize(),3,"P10",3,0)
