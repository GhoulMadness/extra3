...
--
-----------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_Init()
	Mission_InitMovie()
end
-------------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_Start()
	Cutscene_Drown_Init()
end
------------------------------------------------------------------------------------
------------------------------ Cutscene Data ---------------------------------------
function Cutscene_Drown_Text1()
	--empty
end
-------------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_Finished()
	Cutscene_Drown_End()
end
-------------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_Cancel()
	Cutscene_Drown_End()
end
-------------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_SetView()

end
-------------------------------------------------------------------------------------------------------------------------
function Cutscene_Drown_End()
	Mission_EndMovie()
end
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
