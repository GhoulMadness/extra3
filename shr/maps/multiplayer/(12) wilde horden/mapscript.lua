...
EMS_CustomMapConfig =
{
	...
	Callback_OnPeacetimeEnded = function()
		for eID in S5Hook.EntityIterator(Predicate.OfType(Entities.XD_PalisadeGate1)) do
            DestroyEntity(eID);
        end
		for eID in S5Hook.EntityIterator(Predicate.OfType(Entities.XD_Palisade1)) do
            DestroyEntity(eID);
        end
