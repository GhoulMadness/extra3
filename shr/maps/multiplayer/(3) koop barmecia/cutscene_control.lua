...
function Cheat_Cleycourt_Start()
    Cutscene.Start("Cleycourt")
end
...
function Cutscene_Cutscene1_End()
	Mission_EndMovie()
end
...
function Cutscene_Cleycourt_End()
	Mission_EndMovie()
end
