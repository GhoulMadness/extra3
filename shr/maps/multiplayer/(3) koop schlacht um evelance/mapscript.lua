...
gvMapText = ""..
		...
		" @cr @cr @cr @color:150,0,255 Ghoul @color:230,0,240 @cr (3) Schlacht um Evelance "
gvMapVersion = " v1.1 "
...
function StartInitialize()
	...
	--
	GegnerStartTruppen()
	StartCountdown(37*60*gvDiffLVL,AIStart,false)
	StartCountdown(40*60*gvDiffLVL,Felsen,true)
	NVSpawns()
	BanditSpawns()
	--
	StartSimpleJob("Sieg")
...
function Holzhaufen()
	CreateWoodPile("Holz1",400000)
	CreateWoodPile("Holz2",400000)
	CreateWoodPile("Holz3",400000)
	CreateWoodPile("Holz4",400000)
	CreateWoodPile("Holz5",400000)
	CreateWoodPile("Holz6",400000)
	CreateWoodPile("Holz7",400000)
	CreateWoodPile("Holz8",400000)
end
...
function AIStart()
	MapEditor_SetupAI(7, 3, 76800, 3, "Draktarh", 3, 0)
	MapEditor_SetupAI(6, 3, 76800, 3, "Berggegner", 3, 0)
	MapEditor_SetupAI(8, 2, 76800, 2, "P8", 2, 0)
	MapEditor_Armies[8].offensiveArmies.strength = round(28/gvDiffLVL)
	for i = 6,7 do
		MapEditor_Armies[i].offensiveArmies.strength = round(42/gvDiffLVL)
	end
...
function NVSpawns()
	StartCountdown((32+15*gvDiffLVL)*60,NVSpawn,false)
end
function NVSpawn()
	...
	if IsExisting("NVTurm1") then
		...
		armyNV.strength = round((2+Logic.GetTime()/1000)/gvDiffLVL)
	...
	if IsExisting("NebelBurg") then
		...
		armyNV.player 	= 5
		armyNV.id = GetFirstFreeArmySlot(5)
		armyNV.strength = round((4+Logic.GetTime()/500)/gvDiffLVL)
	...
	StartCountdown(7*60*gvDiffLVL,NVSpawn,false)
end

function BanditSpawns()
	StartCountdown((30+12*gvDiffLVL)*60,BanditSpawn,false)
end
function BanditSpawn()
	...
	if IsExisting("BanditTurm1") then
		...
		army.strength = round((2+Logic.GetTime()/1300)/gvDiffLVL)
	...
	if IsExisting("BanditTurm4") then
		...
		army.player 	= 4
		army.id = GetFirstFreeArmySlot(4)
		army.strength = round((3+Logic.GetTime()/600)/gvDiffLVL)
	...
	StartCountdown(7*60*gvDiffLVL,BanditSpawn,false)
end
