...
gvMapText = ""..
		...
		" @cr @cr @cr @color:150,0,255 Ghoul @color:230,0,240 @cr (3) Vargs Bergfestung "
gvMapVersion = " v1.6"
...
function StartInitialize()
	...
	do
		...
		Logic.SetEntityName(Logic.CreateEntity(Entities.XD_ScriptEntity,pos.X,pos.Y-0.01,0,3),"p3_enemy_view_1")
		Logic.SetEntityExplorationRange(GetID("p1_enemy_view_1"), 28)
		Logic.SetEntityExplorationRange(GetID("p2_enemy_view_1"), 28)
		Logic.SetEntityExplorationRange(GetID("p3_enemy_view_1"), 28)
		...
		Logic.SetEntityName(Logic.CreateEntity(Entities.XD_ScriptEntity,pos2.X,pos2.Y-0.01,0,3),"p3_enemy_view_2")
		Logic.SetEntityExplorationRange(GetID("p1_enemy_view_2"), 28)
		Logic.SetEntityExplorationRange(GetID("p2_enemy_view_2"), 28)
		Logic.SetEntityExplorationRange(GetID("p3_enemy_view_2"), 28)
