...
function OptionsDisplay_Menu.S30_SetTextureRes( _Size )
	GDB.SetValue( "Config\\Display\\TextureResolution", _Size )
	OptionsMenu.S31_Start()
end

function OptionsDisplay_Menu.S30_UpdateTextureRes( _Size )
...
----------------------------------------------------------------------------------------------------
-- Update Cutscene Clipping Distance

function OptionsDisplay_Menu.S30_SetClippingDistance( _Distance )
	GDB.SetValue( "Config\\Display\\ClippingDistance", _Distance )
end

function OptionsDisplay_Menu.S30_UpdateClippingDistance( _Distance )
