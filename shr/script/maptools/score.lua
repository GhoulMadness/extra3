...
Score.WinPoints = 200
Score.ResearchPoints = 30
Score.UpgradePoints = 20
Score.BattleSettlersPoints = 5
Score.BattleBuildingPoints = 20
Score.SettlersPoints = 2 
Score.ResourcePoints  = 0.1
Score.ConstructionPoints = 10
